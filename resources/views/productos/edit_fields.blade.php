<div class="row">
    ...
    <div class="form-group col-sm-12 col-md-6">
        ...
        {!! Form::text('lote', $producto->lote, ['class' => 'form-control round', 'required']) !!}
    </div>

    <!-- Fecha Vencimiento Field -->
    <div class="form-group col-sm-12 col-md-6">
        {!! Form::label('fecha_vencimiento', 'Fecha Vencimiento:', ['class' => 'bold']) !!}
        {!! Form::date('fecha_vencimiento', $producto->fecha_vencimiento, ['class' => 'form-control round', 'required']) !!}
    </div>
