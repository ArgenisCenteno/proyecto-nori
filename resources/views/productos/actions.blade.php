<td>
    ...
    <div class='btn-group'>
        <a href="{{ route('productos.edit', [$id]) }}" class='btn btn-info' data-bs-toggle="tooltip"
            ...
            <a href="{{ route('imagenes-producto', [$id]) }}" class='btn btn-success' data-bs-toggle="tooltip"
            data-bs-placement="top" title="Imagenes"><span class="material-icons">photo_camera</span></a>
